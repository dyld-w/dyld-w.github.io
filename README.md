...
- Configured to autodeploy on push to main
- Deployment & pre-deployment checks are handled by [Github Actions](https://docs.github.com/en/actions)
- Built with [Jekyll](https://jekyllrb.com/) based on [al-folio](https://github.com/alshedivat/al-folio)
- Deployed on [Github Pages](https://pages.github.com/)

### Where to Edit What

- **Home Page** &rarr; `_pages/about.md`
- **Personnel Pages** &rarr; `_personnel/` & navigate to correct subdirectory to add or modify a person's information
- **Publications** &rarr; `bibliography/papers.bib` to add or modify citations & `_pages/publications.md` for the publications page itself
- **Repositories** &rarr; `_data/repositories.yml` to add, edit, or remove repositories & `_pages/repositories.md` for the repositories page itself
- **Resources Page** &rarr; `_pages/resources.md`
- **Overall Site Configuration** &rarr; `config.yml`
...
Use [github.dev](https://docs.github.com/en/codespaces/the-githubdev-web-based-editor), Github's web-based editor, to implement & commit the changes.
...
- [UVA Computational Memory Lab Website](#uva-computational-memory-lab-website)
  - [tl;dr Bare Essentials](#tldr-bare-essentials)
    ...
    - [Small Edits \& Updates](#small-edits--updates)
      ...
      - [Multiple Pages or Adding Simple New Page](#multiple-pages-or-adding-simple-new-page)
    - [Large Edits, Refactors, \& Feature Additions](#large-edits-refactors--feature-additions)
